...
import Logo from '/koinX-Logo.svg';
  ...
  return (
    <div className="lg:h-20 h-16 flex font-raleway items-center justify-between shadow-[#1026490F]/10  shadow-md bg-[#FFFFFF] w-full">
      ...
      <div className="hidden lg:flex items-center">
        <Link to={""} className="text-lg font-semibold text-[#0F1629] mr-6">
          Crypto Taxes
        </Link>
        <Link to={""} className="text-lg font-semibold text-[#0F1629] mr-6">
          Free Tools{" "}
      ...
      {isOpen && (
        <div className="lg:hidden absolute top-20 right-0 mt-2 mr-2 bg-white rounded-md shadow-md py-5">
          <div className="text-lg font-semibold text-[#0F1629] px-4 py-2">
            <Link to={""} className="cursor-pointer mb-2">Crypto Taxes</Link>
            <Link to={""} className="cursor-pointer mb-2">Free Tools</Link>
            <Link to={""} className="cursor-pointer">Resource Center</Link>
            <div>
